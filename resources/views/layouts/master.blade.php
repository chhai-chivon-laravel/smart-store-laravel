    ...
    <div class="w3ls-header"><!--header-one-->
        ...
        <div class="w3ls-header-right">
            <ul>
                ...
                <li class="dropdown head-dpdn">
                    <a href="/help" class="dropdown-toggle"><i class="fa fa-question-circle" aria-hidden="true"></i> Help</a>
                </li>
            </ul>
        </div>
    ...
    <div class="header-two"><!-- header-two -->
        <div class="container">
            <div class="header-logo">
                <h1><a href="/"><span>S</span>mart <i>Store</i></a></h1>
            ...
            <div class="header-cart">
                <div class="my-account">
                    <a href="/contact"><i class="fa fa-map-marker" aria-hidden="true"></i> CONTACT US</a>
                </div>
                <div class="cart">
